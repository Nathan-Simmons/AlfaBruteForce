#!/bin/bash
#code was modified from InstaInsane v1.0
trap 'store; exit 1;' 2
...
printf "  Instagram Brute Forcer - MultiThread \n "
...
printf "\e[1;92mInvalid Username! Try again\e[0m\n"
sleep 1
start
else
...
printf "\e[1;92mStarting Tor Connections please have some patience .. \e[0m\n"
...
printf "\e[1;92mOK! All Tor Connections OK \e[0m\n"
let checkcount++
fi
